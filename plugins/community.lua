return {
  ...
  { import = "astrocommunity.editing-support.auto-save-nvim", enabled = true },
  ...
  -- {
  --   'auto-save.nvim',
  --   trigger_events = {"InsertLeave", "TextChanged","CursorMoved", "CursorMovedI", "InsertChange", "TextChangedI", "InsertCharPre" }
  -- }
}
